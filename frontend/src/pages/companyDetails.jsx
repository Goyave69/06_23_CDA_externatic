  ...
  const fakeData = [
    {
      ...
      description:
        "Shell est une société énergétique internationale spécialisée dans l’exploration, la production, le raffinage et la commercialisation du pétrole et du gaz naturel, ainsi que dans la fabrication et la commercialisation de produits chimiques.\n\nNous utilisons des technologies de pointe et adoptons une approche innovante pour aider à construire un avenir énergétique durable. Nous investissons également dans l’énergie, y compris à partir de sources à faible émission de carbone telles que l’énergie éolienne et solaire, et de nouveaux carburants pour les transports, tels que les biocarburants avancés et l’hydrogène.\n\nShell plc a été fondée en 1907, bien que notre histoire remonte à la première moitié du 19ème siècle. Notre siège social est à La Haye, aux Pays-Bas. La société mère du groupe Shell est Shell plc, qui est enregistrée en Angleterre et au Pays de Galles. Le directeur général est Ben van Beurden.",
  ...
  return (
    ...
    >
      <div>
        ...
        >
          <img
            src={fakeData[0].photo_url}
            alt={fakeData[0].companyName}
            style={{
              transform: "scale(1.0)",
              height: "500px",
              width: "30%",
          ...
          >
            <div style={{ fontSize: "1.5rem" }}>{fakeData[0].description}</div>
          </div>
        </div>
      </div>
    </Box>
